...
function renderArtist(lang) {
  ...
  main.innerHTML = `
        <section class="artist-hero" aria-label="${nombre}">
            ...
            <div class="artist-hero-content">
                ...
                ${
                  a.instagram
                    ? `<a href="${a.instagram}" target="_blank" rel="noopener" class="artist-hero-ig" aria-label="${nombre}">
        ...
        <section class="artist-bio">
            <div class="artist-bio-inner">
                ...
                <div class="artist-bio-text">
                    ${bio.map((p) => `<p class="artist-bio-text-p">${p}</p>`).join("")}
                </div>
            </div>
        </section>`
            : ""
  ...
  if (obraEls.length && obras.length) {
    ...
    function navigate(dir) {
      ...
      modalTitulo.textContent = titulo || "";
      gsap.fromTo(modalImg.parentElement, { scale: 0.9, opacity: 0 }, { scale: 1, opacity: 1, duration: 0.4, ease: "power3.out" });
    }
