...
/* ==========================================================================
   events.php — Endpoint JSON per a events (Victoria Taylor)
   ==========================================================================
   Accions disponibles:
   - action=list     → Retorna el llistat d'events
   - action=view&id=X → Retorna un event individual
...
if ($action === 'view' && $id) {
    ...
    if ($result === null || !isset($result['data'])) {
        ...
        echo json_encode(['error' => 'Event no trobat'], JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
        exit;
    }
