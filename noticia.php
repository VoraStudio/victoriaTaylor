...
$titul = htmlspecialchars($noticia['titul'] ?? '', ENT_QUOTES, 'UTF-8');
...
$metaDesc = $noticia['subtitol'] ? htmlspecialchars(mb_substr(strip_tags($noticia['subtitol']), 0, 155), ENT_QUOTES, 'UTF-8') : 'Article complet amb detalls de l\'exposicio o esdeveniment artistic.';
    ...
    <header id="header" class="main-header" aria-label="Navegació principal">
        <div class="header-container">
            ...
            <nav class="desktop-nav" aria-label="Navegació de sobretaula">
                <ul class="nav-list">
                    ...
                    <li><a href="html/agencias.html" class="nav-link" data-i18n="nav.agenda">Agenda</a></li>
        ...
        <nav id="mobile-nav" class="mobile-nav" aria-label="Navegació mòbil">
            ...
            <ul class="mobile-nav-list">
                ...
                <li><a href="html/agencias.html" class="mobile-link" data-i18n="nav.agenda">Agenda</a></li>
        ...
        <div class="footer-grid">
            ...
            <div class="footer-nav-col">
                ...
                <ul class="footer-nav">
                    ...
                    <li><a href="html/agencias.html" data-i18n="nav.agenda">Agenda</a></li>
