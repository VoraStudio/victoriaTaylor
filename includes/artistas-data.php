<?php
/* ══════════════════════════════════════════════════════════════
   artistas-data.php — Dades hardcodejades dels 7 artistes fixos
   ══════════════════════════════════════════════════════════════
   Utilitzat per artistas.php i artista.php com a base.
   Les dades del CMS (nous artistes) es mergegen sobre aquesta.
   ══════════════════════════════════════════════════════════════ */
...
$ARTISTAS_FIJOS = [
    'cristina-montero' => [
        ...
        'rol' => ['es' => 'Artista plástica y arquitecta', 'ca' => 'Artista plàstica i arquitecta', 'en' => 'Visual artist and architect'],
        ...
        'logros' => [
            ['año' => '2024', 'textos' => ['es' => ['Miembro del jurado en el concurso "LA BATALLA DE LES FLORS" — Centro de Iniciativas Turísticas de Olot', 'Exposición de la escultura "FLORACIÓ" — Festival VALLVIVA'], 'ca' => ['Membre del jurat al concurs "LA BATALLA DE LES FLORS" — Centre d\'Iniciatives Turístiques d\'Olot', 'Exposició de l\'escultura "FLORACIÓ" — Festival VALLVIVA'], 'en' => ['Jury member at the "LA BATALLA DE LES FLORS" competition — Olot Tourist Initiatives Centre', 'Exhibition of the "FLORACIÓ" sculpture — VALLVIVA Festival']]],
            ['año' => '2023', 'textos' => ['es' => ['Exposición de la escultura "FORTUNA I DESTÍ" — Festival VALLVIVA', 'Presentación de la colección "Fotosíntesi"'], 'ca' => ['Exposició de l\'escultura "FORTUNA I DESTÍ" — Festival VALLVIVA', 'Presentació de la col·lecció "Fotosíntesi"'], 'en' => ['Exhibition of the "FORTUNA I DESTÍ" sculpture — VALLVIVA Festival', 'Presentation of the "Fotosíntesi" collection']]],
            ['año' => '2022', 'textos' => ['es' => ['Exposición de la escultura "IL·LUSIÓ" — Festival VALLVIVA'], 'ca' => ['Exposició de l\'escultura "IL·LUSIÓ" — Festival VALLVIVA'], 'en' => ['Exhibition of the "IL·LUSIÓ" sculpture — VALLVIVA Festival']]],
            ['año' => '2020', 'textos' => ['es' => ['Espai HVNGARI — Andorra', 'Món d\'Harmonia — Barcelona', 'Àmbit Sant Lluc — Olot', 'Claustro de la Mercè — Girona', 'Jardines de la Riba — Vall de Bianya'], 'ca' => ['Espai HVNGARI — Andorra', 'Món d\'Harmonia — Barcelona', 'Àmbit Sant Lluc — Olot', 'Claustre de la Mercè — Girona', 'Jardins de la Riba — Vall de Bianya'], 'en' => ['Espai HVNGARI — Andorra', 'Món d\'Harmonia — Barcelona', 'Àmbit Sant Lluc — Olot', 'Claustre de la Mercè — Girona', 'Jardins de la Riba — Vall de Bianya']]],
            ['año' => '2019', 'textos' => ['es' => ['Exposición de la colección "Unitat" — Galería-estudio, Olot', 'Àmbit Sant Lluc — Olot'], 'ca' => ['Exposició de la col·lecció "Unitat" — Galeria-estudi, Olot', 'Àmbit Sant Lluc — Olot'], 'en' => ['Exhibition of the "Unitat" collection — Gallery-studio, Olot', 'Àmbit Sant Lluc — Olot']]],
            ['año' => '2018', 'textos' => ['es' => ['Art Karlsruhe Rheinstetten — Alemania'], 'ca' => ['Art Karlsruhe Rheinstetten — Alemanya'], 'en' => ['Art Karlsruhe Rheinstetten — Germany']]]
        ],
        'obras' => [
    ...
    'iol-baques' => [
        'id' => 'iol-baques',
        'nombre' => 'IOL Baqués',
        'rol' => ['es' => 'Artista abstracta', 'ca' => 'Artista abstracta', 'en' => 'Abstract artist'],
    ...
    'juda-munoz' => [
        'id' => 'juda-munoz',
        'nombre' => 'Judà Muñoz',
        'rol' => ['es' => 'Artista de expresionismo abstracto', 'ca' => 'Artista d\'expressionisme abstracte', 'en' => 'Abstract expressionist artist'],
        ...
        'logros' => [
            ['año' => '2025', 'textos' => ['es' => ['Exposición en la galería ESPAI BARRI VELL — Girona'], 'ca' => ['Exposició a la galeria ESPAI BARRI VELL — Girona'], 'en' => ['Exhibition at ESPAI BARRI VELL gallery — Girona']]],
            ['año' => '2024', 'textos' => ['es' => ['Exposición en el Edificio LA FARINERA — Girona', 'Inclusión en el fondo de arte de Cruz Roja en Barcelona'], 'ca' => ['Exposició a l\'Edifici LA FARINERA — Girona', 'Inclusió al fons d\'art de Creu Roja a Barcelona'], 'en' => ['Exhibition at LA FARINERA Building — Girona', 'Inclusion in the Red Cross art collection in Barcelona']]],
            ['año' => '2023', 'textos' => ['es' => ['Museo LEONARDO DA VINCI — Milán', 'Participación en RECICLART — Sitges'], 'ca' => ['Museu LEONARDO DA VINCI — Milà', 'Participació a RECICLART — Sitges'], 'en' => ['LEONARDO DA VINCI Museum — Milan', 'Participation in RECICLART — Sitges']]],
            ['año' => '2022', 'textos' => ['es' => ['Galardonado en ART MARBELLA'], 'ca' => ['Guardonat a ART MARBELLA'], 'en' => ['Awarded at ART MARBELLA']]],
            ['año' => '2021', 'textos' => ['es' => ['Participación en ART DUBAI'], 'ca' => ['Participació a ART DUBAI'], 'en' => ['Participation in ART DUBAI']]]
        ],
        'obras' => [
    ...
    'mohammed-er-rabehy' => [
        ...
        'rol' => ['es' => 'Artista plástico contemporáneo', 'ca' => 'Artista plàstic contemporani', 'en' => 'Contemporary visual artist'],
        ...
        'logros' => [
            ['año' => '2024', 'textos' => ['es' => ['Subdelegación del Gobierno — Girona', 'Centro Cívico ONYAR — Girona', 'Centro Cívico SANT NARCÍS — Girona'], 'ca' => ['Subdelegació del Govern — Girona', 'Centre Cívic ONYAR — Girona', 'Centre Cívic SANT NARCÍS — Girona'], 'en' => ['Government Sub-delegation — Girona', 'ONYAR Civic Centre — Girona', 'SANT NARCÍS Civic Centre — Girona']]],
            ['año' => '2023', 'textos' => ['es' => ['Centro Cívico TER — Girona'], 'ca' => ['Centre Cívic TER — Girona'], 'en' => ['TER Civic Centre — Girona']]],
            ['año' => '2022', 'textos' => ['es' => ['Festival Internacional Art i Gavarres — Celrà', 'Exposición colectiva "Cápsula de arte emergente" — Bescanó'], 'ca' => ['Festival Art i Gavarres Internacional — Celrà', 'Exposició col·lectiva "Càpsula d\'art emergent" — Bescanó'], 'en' => ['International Art i Gavarres Festival — Celrà', 'Group exhibition "Emerging Art Capsule" — Bescanó']]],
            ['año' => '2021', 'textos' => ['es' => ['Museo Etnográfico — Ripoll'], 'ca' => ['Museu Etnogràfic — Ripoll'], 'en' => ['Ethnographic Museum — Ripoll']]],
            ['año' => '2020', 'textos' => ['es' => ['Amigos del Museo de Arte — Girona', 'Palau de l\'Abadia — Sant Joan de les Abadesses'], 'ca' => ['Amics del Museu d\'Art — Girona', 'Palau de l\'Abadia — Sant Joan de les Abadesses'], 'en' => ['Friends of the Art Museum — Girona', 'Palau de l\'Abadia — Sant Joan de les Abadesses']]],
            ['año' => '2019', 'textos' => ['es' => ['Museo de la Garrotxa — Olot', 'Galería Abartium — Vic', 'Hotel Picasso — Torroella de Montgrí', 'Castillo de Montesquiu — Barcelona'], 'ca' => ['Museu de la Garrotxa — Olot', 'Galeria Abartium — Vic', 'Hotel Picasso — Torroella de Montgrí', 'Castell de Montesquiu — Barcelona'], 'en' => ['Museum of La Garrotxa — Olot', 'Abartium Gallery — Vic', 'Hotel Picasso — Torroella de Montgrí', 'Montesquiu Castle — Barcelona']]],
            ['año' => '2018', 'textos' => ['es' => ['Cafè Art Fontanella — Olot', 'Espai Jove — Girona'], 'ca' => ['Cafè Art Fontanella — Olot', 'Espai Jove — Girona'], 'en' => ['Cafè Art Fontanella — Olot', 'Espai Jove — Girona']]],
            ['año' => '2017', 'textos' => ['es' => ['El Racó de la Font — Olot', 'Galería Les Voltes — Olot'], 'ca' => ['El Racó de la Font — Olot', 'Galeria Les Voltes — Olot'], 'en' => ['El Racó de la Font — Olot', 'Les Voltes Gallery — Olot']]]
        ],
        'obras' => [
    ...
    'rosa-martin' => [
        'id' => 'rosa-martin',
        'nombre' => 'Rosa Martín',
        'rol' => ['es' => 'Artista plástica y docente', 'ca' => 'Artista plàstica i docent', 'en' => 'Visual artist and teacher'],
        ...
        'logros' => [
            ['año' => '2019', 'textos' => ['es' => ['"Pedra sobre pedra" — Àmbit Espai d\'Art, Olot', 'Lluèrnia — Olot'], 'ca' => ['"Pedra sobre pedra" — Àmbit Espai d\'Art, Olot', 'Lluèrnia — Olot'], 'en' => ['"Pedra sobre pedra" — Àmbit Espai d\'Art, Olot', 'Lluèrnia — Olot']]],
            ['año' => '2018', 'textos' => ['es' => ['"Les mans que miren, les mans que pensen" — Àmbit Espai d\'Art, Olot'], 'ca' => ['"Les mans que miren, les mans que pensen" — Àmbit Espai d\'Art, Olot'], 'en' => ['"Les mans que miren, les mans que pensen" — Àmbit Espai d\'Art, Olot']]]
        ],
        'obras' => [
    ...
    'hubo' => [
        'id' => 'hubo',
        'nombre' => 'HUBO',
        'rol' => ['es' => 'Colaboración artística entre un artesano del hierro y un experimentador', 'ca' => 'Col·laboració artística entre un artesà del ferro i un experimentador', 'en' => 'Artistic collaboration between an iron craftsman and an experimenter'],
