<?php
/* ══════════════════════════════════════════════════════════════
   index.php — Pàgina d'inici SSR amb tracking (Victoria Taylor)
   ══════════════════════════════════════════════════════════════ */
...
<html lang="cat">
  <head>
    ...
    <meta
      name="description"
      content="Galeria d'art contemporani a Girona. Descobreix artistes, exposicions i esdeveniments. Victoria Taylor selecciona i impulsa talent artistic."
    />
    <meta name="keywords" content="galeria d'art, art contemporani, Girona, artistes, exposicions, galeria art Girona" />
    <meta name="author" content="Victoria Taylor - Global Brands Europe, SL" />

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://victoriataylor.art/" />
    <meta property="og:title" content="Inicio | Victoria Taylor" />
    <meta
    ...
    <meta name="twitter:title" content="Inicio | Victoria Taylor" />
    <meta
    ...
    <!-- Canonical -->
    <link rel="canonical" href="https://victoriataylor.art/" />

    <!-- Favicon -->
    <link rel="icon" type="image/avif" href="img/logo.avif" />
    <link rel="apple-touch-icon" href="img/logo.avif" />

    <title>Inicio | Victoria Taylor</title>

    <!-- Swiper CSS: Estils base per al slider -->
  ...
  <body>
    ...
    <header id="header" class="main-header" aria-label="Navegació principal">
      <div class="header-container">
        ...
        <div class="logo">
          <a href="#header" aria-label="Inici Victoria Taylor">
    ...
    <main>
      <!-- Secció del slider amb etiqueta d'accessibilitat -->
      <section class="hero-slider" aria-label="Portfoli de Victoria Taylor">
        <!-- Estructura principal de Swiper -->
        <div class="swiper mySwiper">
          <div class="swiper-wrapper">
            ...
            <!-- Slide 4 -->
            <article class="swiper-slide">
              <div class="slide-bg" style="background-image: url(&quot;img/slide4.avif&quot;)"></div>
              <div class="slide-content">
                <span class="slide-subtitle" data-i18n="hero.slide4.subtitle">Obras Selectas</span>
                <h1 class="slide-title" data-i18n="hero.slide4.title">Edición Limitada</h1>
              </div>
            </article>
            ...
            <article class="swiper-slide">
              ...
              <div class="slide-content">
                <span class="slide-subtitle" data-i18n="hero.slide5.subtitle">Vogue Style</span>
                <h1 class="slide-title" data-i18n="hero.slide5.title">Elegant</h1>
              </div>
            </article>
            ...
            <article class="swiper-slide">
              ...
              <div class="slide-content">
                <span class="slide-subtitle" data-i18n="hero.slide6.subtitle">New Collection</span>
        ...
        <!-- Navegació manual (fletxes) amb suport per a lectors de pantalla -->
        <nav class="nav-arrows" aria-label="Navegació del slider">
          <button class="nav-arrow prev-btn" aria-label="Anterior slide">anterior</button>
          <button class="nav-arrow next-btn" aria-label="Següent slide">seguent</button>
        </nav>
      </section>
    </main>

    <!-- Swiper JS: Lògica del slider -->
      ...
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <div class="footer-social">
            <a
              href="https://www.instagram.com/victoriataylor.art/"
              target="_blank"
              rel="noopener"
              class="footer-social-link"
              aria-label="Instagram Victoria Taylor"
            >
              <svg
                width="18"
                height="18"
